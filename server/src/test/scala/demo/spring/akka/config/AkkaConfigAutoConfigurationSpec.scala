...
import demo.spring.akka.SpringLogging
...
class AkkaConfigAutoConfigurationSpec extends FlatSpec with TestContextManagement with Matchers with SpringLogging {
...
object AkkaConfigAutoConfigurationSpec {
  ...
  val TEST_URL = new URL("https://www.baidu.com")
